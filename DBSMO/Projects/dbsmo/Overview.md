...
- Student: signs in, views visible problem sets, submits answers, tracks attempts, uses practice mode, sees assignments, manages profile/privacy, and appears on leaderboard if enabled (sources: `app/dashboard/page.tsx`, `app/problem-sets/page.tsx`, `app/problem-sets/[slug]/answer-grid.tsx`, `app/practice/page.tsx`, `app/settings/page.tsx`, `app/leaderboard/page.tsx`).
...
- Problem set catalog and answering: `app/problem-sets/page.tsx`, `app/problem-sets/[slug]/page.tsx`, `app/problem-sets/[slug]/answer-grid.tsx`, `app/api/submit/route.ts`.
